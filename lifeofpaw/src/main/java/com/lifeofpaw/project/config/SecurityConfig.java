    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/animals/all", "/api/animals/available", "/api/animals/search", "/api/animals/public/**", "/api/animals/get-particular/**", "/api/users/get-particular/**").permitAll()
                .requestMatchers("/api/orgs/all", "/api/orgs/public/**").permitAll()
